...
def score_sequence_from_scales(
    ...
    # Assumes updated raman_cool_with_pumping accepts (P,4) host pulses
    ...
    # Length penalty
    total_pulses = int(pulses_host.shape[0])
...
def run_omega_time_ga(cfg: OmegaTimeGAConfig, res: cr.GPUResources) -> None:
    ...
    def evaluate(ind: np.ndarray) -> tuple:
        ...
        score, raw = score_sequence_from_scales(
            axes,
            dns,
            inverse,
            baseline_omega_lin,
    ...
    for gen in range(cfg.n_gen):
        ...
        meta = {
            ...
            "omega_scales": omega_scales.tolist(),   # optional but useful
            "time_scales": t_scales.tolist(),        # optional but useful
        }
    ...
    for rank, ind in enumerate(hof, 1):
        ...
        meta = {
            ...
            "omega_vector": omega_vec,       # NEW
            "time_vector": time_vec,         # NEW
            "omega_scales": omega_scales.tolist(),   # optional
            "time_scales": t_scales.tolist(),        # optional
        }
